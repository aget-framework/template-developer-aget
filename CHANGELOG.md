...
### Added
- Archetype-specific skills: `aget-run-tests`, `aget-lint-code`, `aget-review-pr`
- Formal ontology: `ontology/ONTOLOGY_developer.yaml` (10 concepts, 4 clusters)
...
- README structure: "Why Developer?" value proposition
