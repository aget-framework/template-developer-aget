...
# 2. Source this file: source shell/developer_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-developer-aget}"
export AGET_ARCHETYPE="developer"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Developer_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Developer_VOCABULARY.md"
